...
[NOTE]
====
For guest cluster storage scaling guidelines and V2 Data Engine resource limits, see xref:integrations/rancher/csi-driver.adoc#_scaling_and_resource_limits[Harvester CSI Driver].
====
